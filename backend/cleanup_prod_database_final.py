#!/usr/bin/env python3
"""
Script de nettoyage final de la base de données de production
Utilise les credentials corrects du .env
"""
...
# Configuration de la base de données de production (selon le .env)
DB_CONFIG = {
    'host': '185.143.103.162',
    'port': 5432,
    'database': 'ecofin_pub',
    'user': 'user',
    'password': 'password'  # À ajuster selon les vrais credentials
}
...
def get_db_connection():
    ...
    try:
        ...
        print("💡 Vérifiez les credentials dans le fichier .env")
        sys.exit(1)
...
def cleanup_database():
    ...
    try:
        print("🧹 Début du nettoyage de la base de données de production...")
...
if __name__ == "__main__":
    print("🧹 Script de nettoyage de la base de données de production")
    print("=" * 70)
