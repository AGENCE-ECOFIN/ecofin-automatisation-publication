#!/usr/bin/env python3
"""
Script de nettoyage de la base de données locale (Docker)
Supprime les feeds, posts et historique tout en gardant les configurations et utilisateurs
"""
...
# Configuration de la base de données locale (Docker)
DB_CONFIG = {
    'host': 'localhost',
    'port': 5432,
...
def cleanup_database():
    ...
    try:
        print("🧹 Début du nettoyage de la base de données locale...")
...
if __name__ == "__main__":
    print("🧹 Script de nettoyage de la base de données locale (Docker)")
    print("=" * 70)
