#!/usr/bin/env python3
"""
Script pour corriger la base de données locale (Docker)
...
DB_CONFIG = {
    'host': 'localhost',
    'port': 5432,
    'database': 'ecofin_publication',  # Selon docker-compose.yml
    'user': 'ecofin_user',  # Selon docker-compose.yml
    'password': 'changeme'  # Selon docker-compose.yml
}
...
if __name__ == "__main__":
    print("🔧 Script de correction de la base de données locale (Docker)")
    print("=" * 70)
